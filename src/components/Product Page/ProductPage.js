...
export const ProductPage = () => {
  ...
  return (
    <div className="product-page-container" style={isDark ? dark : light}>
      ...
      <p className="product-name">{productPage.description.author.name}</p>
      <h3 className="product-name">About</h3>
      <p className="product-name">{productPage.description.author.about}</p>
      <h3 className="product-name">Reviews</h3>
      <ul className="review-list">
        {productPage.description.review.map((item) => (
